...
<?php endif; ?>
   ...
   <div id="preheader">
        ...
        <a href="http://www.seaportvillage.com" class="btn btn-sm btn-default"><span class="visible-sm-inline visible-md-inline visible-lg-inline">Discover </span>Seaport Village</a> 
        <a href="<?php print $front_page; ?>" class="btn btn-sm btn-default active"><span class="visible-sm-inline visible-md-inline visible-lg-inline">Explore </span>The Headquarters at Seaport</a>
   </div>
                     ...
                     <?php if ($logo): ?>
                           <div class="h1 logo">
                                 <a href="<?php print $front_page; ?>" rel="home" id="logo">
                                       <img src="<?php print $logo; ?>" alt="The Headquarters at Seaport"/>
                                 </a>
                           </div>
                     <?php endif; ?>
